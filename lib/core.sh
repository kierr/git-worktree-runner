...
resolve_base_dir() {
	...
	# Check config first (gwr.worktrees.dir), then environment (GWR_WORKTREES_DIR), then default
	base_dir=$(cfg_default "gwr.worktrees.dir" "GWR_WORKTREES_DIR" "")
...
resolve_default_branch() {
	...
	# Check config first
	configured_branch=$(cfg_default "gwr.defaultBranch" "GWR_DEFAULT_BRANCH" "auto")
